...
namespace OnlineBookLibrary.Controllers
{
    public class GenresController : Controller
    {
        ...
        public GenresController(OnlineBookLibraryContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Index()
        {
              return _context.Genre != null ? 
                          ...
                          Problem("Entity set 'OnlineBookLibraryContext.Genre'  is null.");
        }
        ...
        public async Task<IActionResult> DeleteConfirmed(string id)
        {
            ...
            {
                return Problem("Entity set 'OnlineBookLibraryContext.Genre'  is null.");
            }
            var genre = await _context.Genre.FindAsync(id);
            if (genre != null)
            {
